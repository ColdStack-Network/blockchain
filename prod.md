...
Валидатор-ноды дублируют друг друга. Блокчейн продолжает работать и производить
блоки, пока есть хотя бы одна валидатор-нода. Таким образом, для минимального
high-availability нужны хотя бы две валидатор-ноды.
